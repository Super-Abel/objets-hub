...
export const en: Dictionary = {
  ...
  edit: {
    trigger: 'Edit',
    heading: 'Edit object',
    description: 'Update the title, description or image.',
    title: 'Title',
    descriptionField: 'Description',
    image: 'Image',
    imageHint: (maxMb: number) =>
      `Leave empty to keep the current image · JPEG, PNG, WebP or GIF · max ${maxMb} MB`,
    currentImageAlt: 'Current image',
    newImageAlt: 'New image',
    replaceImage: 'Replace image',
    clearImage: 'Cancel replacement',
    cancel: 'Cancel',
    submit: 'Save',
    submitting: 'Saving…',
    saved: 'Object updated',
